...
1. Создаём файл конфигурации ```CMakePresets.json```. Внутренности:
```
{
    "version": 3,
    "configurePresets": [
...
Соотвественно в блоке кода представленного выше (if (WIN32)....endif (WIN32)) необходимости нет, его можно убрать.
